...
export interface ApiCheckInCheckIn extends Schema.CollectionType {
  ...
  attributes: {
    CustomerName: Attribute.Text;
    CustomerPhone: Attribute.BigInteger;
    CustomerEmail: Attribute.Email;
    CheckinDate: Attribute.Date;
    CheckoutDate: Attribute.Date;
...
export interface ApiRoomRoom extends Schema.CollectionType {
  ...
  attributes: {
    ...
    RoomDescription: Attribute.Text;
    RoomId: Attribute.BigInteger;
    RoomPrice: Attribute.Integer;
    RoomImages: Attribute.Media;
